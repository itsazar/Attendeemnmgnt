/**
 * demoattendee — src/app/api/events/import/route.ts
 *
 * Brief: Handle Excel imports of confirmed participants and create events.
 */
...
/** Internal summary payload type for import endpoint. */
type SummaryPayload = {
...
export async function POST(request: Request) {
  try {
    ...
    const errorMessage =
      error instanceof Error ? error.message : "Unable to import participants";
